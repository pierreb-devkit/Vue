...
export const packs = [
  {
    ...
    info: null,
    features: [
      { icon: 'fa-solid fa-spider', color: 'primary', text: '~50 typical scrap runs' },
      { icon: 'fa-solid fa-wand-magic-sparkles', color: 'primary', text: '~20 autofix sessions' },
  ...
  },
  {
    ...
    info: null,
    features: [
      { icon: 'fa-solid fa-spider', color: 'primary', text: '~200 typical scrap runs' },
      { icon: 'fa-solid fa-wand-magic-sparkles', color: 'primary', text: '~80 autofix sessions' },
      { icon: 'fa-solid fa-infinity', color: 'primary', text: 'Never expires (24mo)' },
    ],
  ...
  },
  {
    ...
    info: null,
    features: [
      { icon: 'fa-solid fa-spider', color: 'primary', text: '~1,000 typical scrap runs' },
      { icon: 'fa-solid fa-wand-magic-sparkles', color: 'primary', text: '~400 autofix sessions' },
      { icon: 'fa-solid fa-tag', color: 'success', text: 'Saves ~10% vs Small Pack' },
      { icon: 'fa-solid fa-infinity', color: 'primary', text: 'Never expires (24mo)' },
    ],
