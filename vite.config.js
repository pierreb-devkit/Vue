...
export default defineConfig(({ mode }) => {
  return {
    plugins: [
      ...
      // Pre-render configured routes at build time for SEO
      // Only active in production when seo.prerender.enabled is true
      ...(mode === 'production' ? [prerenderPlugin(appConfig)].filter(Boolean) : []),
    ],
